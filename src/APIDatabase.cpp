...
bool APIDatabase::testConnection() {
    try {
        std::string response = httpGet("/api/health");
...
// ========================================
// ItemType operations (stub implementations)
// ========================================

bool APIDatabase::saveItemType(std::shared_ptr<ItemType> itemType) {
    if (!isConnected() || !itemType) return false;
    
    // TODO: Implement HTTP POST/PUT to /api/item-types endpoint
    // Serialize itemType to JSON and send to API
    std::cerr << "APIDatabase::saveItemType not yet implemented" << std::endl;
    return false;
}

std::shared_ptr<ItemType> APIDatabase::loadItemType(const UUID& id) {
    if (!isConnected()) return nullptr;
    
    // TODO: Implement HTTP GET from /api/item-types/:id endpoint
    // Parse JSON response and construct ItemType object
    std::cerr << "APIDatabase::loadItemType not yet implemented" << std::endl;
    return nullptr;
}

bool APIDatabase::deleteItemType(const UUID& id) {
    if (!isConnected()) return false;
    
    // TODO: Implement HTTP DELETE to /api/item-types/:id endpoint
    std::cerr << "APIDatabase::deleteItemType not yet implemented" << std::endl;
    return false;
}

std::vector<std::shared_ptr<ItemType>> APIDatabase::loadAllItemTypes() {
    if (!isConnected()) return {};
    
    // TODO: Implement HTTP GET from /api/item-types endpoint
    // Parse JSON array response and construct ItemType objects
    std::cerr << "APIDatabase::loadAllItemTypes not yet implemented" << std::endl;
    return {};
}
